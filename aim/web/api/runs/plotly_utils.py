...
from aim.web.api.runs.utils import collect_run_streamable_data, IndexRange, get_run_props
...
async def plotly_search_result_streamer(traces: SequenceCollection,
