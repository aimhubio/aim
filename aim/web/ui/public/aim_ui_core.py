...
class ToggleButton(Component):
    def __init__(self, defaultValue=None, leftLabel=None, leftValue=None, rightLabel=None, rightValue=None, disabled=None, size=None, color=None, on_change=None, key=None):
