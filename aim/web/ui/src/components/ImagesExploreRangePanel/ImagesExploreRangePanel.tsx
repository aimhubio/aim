    ...
    <form className='ImagesExploreRangePanel' onSubmit={handleSearch}>
      <div className='ImagesExploreRangePanel__container'>
        <div className='ImagesExploreRangePanel__container__sliderContainer'>
          ...
          <div className='ImagesExploreRangePanel__container__sliderContainer__sliderBox'>
            <Slider
              value={recordSlice}
          ...
          <Text
            ...
            weight={600}
            tint={80}
            className='ImagesExploreRangePanel__container__sliderContainer__sliderValuesLabel'
          >{`${recordSlice[0]} - ${recordSlice[1]}`}</Text>
          <Text
            className='ImagesExploreRangePanel__container__sliderContainer__densityFieldLabel'
            size={10}
            weight={500}
            tint={70}
            color='primary'
          ...
          <input
            ...
            className={`ImagesExploreRangePanel__container__sliderContainer__densityField ${
              recordDensity == 0
                ? 'ImagesExploreRangePanel__container__sliderContainer__densityField-invalid'
                : ''
            }`}
          />
        </div>
