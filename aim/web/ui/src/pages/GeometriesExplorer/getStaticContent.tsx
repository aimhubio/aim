...
function getGeometriesExplorerStaticContent(
  type: StaticContentType,
): React.ReactNode {
  const illustrationContent = getGeometriesExplorerIllustrationContent(type);
  return getBaseExplorerStaticContent(type, illustrationContent);
}

function getGeometriesExplorerIllustrationContent(
  type: StaticContentType,
): React.ReactNode {
  ...
  const Insufficient_Resources = "You don't have any tracked geometries";
...
export default getGeometriesExplorerStaticContent;
