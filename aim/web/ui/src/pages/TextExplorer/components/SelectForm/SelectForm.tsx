...
function SelectForm({
  ...
  function handleSearch(e: React.ChangeEvent<any>): void {
    ...
    // trackEvent(ANALYTICS_EVENT_KEYS.texts.searchClick);
  }
      ...
      <div className='SelectForm__container'>
        <div className='SelectForm__metrics__container'>
          <Box display='flex'>
            <Box
              ...
              alignItems='center'
            >
              {selectedTextsData?.advancedMode ? (
                <div className='SelectForm__textarea'>
                  <ExpressionAutoComplete
                    isTextArea={true}
                    onExpressionChange={onSelectAdvancedQueryChange}
                    onSubmit={handleSearch}
                    value={selectedTextsData?.advancedQuery}
                    placeholder='texts.name in [“loss”, “accuracy”] and run.learning_rate > 10'
                    options={[
                      'texts.name',
                      'texts.context',
        ...
        <div className='SelectForm__search__container'>
          ...
          <div className='SelectForm__search__actions'>
            ...
            <Button
              className={selectedTextsData?.advancedMode ? 'active' : ''}
              withOnlyIcon={true}
