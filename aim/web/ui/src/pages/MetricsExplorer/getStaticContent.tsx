...
function getMetricsExplorerStaticContent(
  type: StaticContentType,
): React.ReactNode {
  const illustrationContent = getMetricsExplorerIllustrationContent(type);
  return getBaseExplorerStaticContent(type, illustrationContent);
}

function getMetricsExplorerIllustrationContent(
  type: StaticContentType,
): React.ReactNode {
  ...
  const Insufficient_Resources = "You don't have any tracked metrics";
...
export default getMetricsExplorerStaticContent;
