  ...
  options: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Option 2', value: 'option2-2' },
        { label: 'Option 3', value: 'option2-3' },
      ],
    },
    {
      group: 'Group 3',
      options: [
        ...
        { label: 'Option 2', value: 'option3-2' },
        { label: 'Option 3', value: 'option3-3' },
      ],
    },
    {
      group: 'Group 4',
      options: [
        ...
        { label: 'Option 2', value: 'option4-2' },
        { label: 'Option 3', value: 'option4-3' },
      ],
    },
  ],
};
