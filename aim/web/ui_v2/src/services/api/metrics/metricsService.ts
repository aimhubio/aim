            ...
            series: [
              {
                ...
                data: {
                  ...
                  steps: new Int32Array([0, 1, 2, 3, 4, 5, 6]),
                  epochs: new Int32Array([0, 0, 1, 1, 1, 2, 2]),
                  iterations: new Int32Array([0, 1, 2, 3, 4, 5, 6]),
                  timestamp: new Int32Array([
              ...
              },
              {
                ...
                data: {
                  ...
                  steps: new Int32Array([0, 1, 2]),
                  epochs: new Int32Array([0, 1, 2]),
                  iterations: new Int32Array([0, 1, 2]),
                  timestamp: new Int32Array([
