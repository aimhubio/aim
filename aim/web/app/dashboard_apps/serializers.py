...
from aim.web.app.utils import BaseModelSerializer, BaseSerializer, Field, ModelField
...
def explore_state_response_serializer(es_object):
    ...
    response_schema = {
        ...
        'chart': {
            'focused': {
                ...
                'settings': {
                    ...
                    'zoomHistory': json.loads(es_object.chart_settings_zoom_history),
                    ...
                    'persistent': {
                        ...
                        'zoom': json.loads(es_object.chart_settings_persistent_zoom),
                        'indicator': es_object.chart_settings_persistent_indicator,
                        'xAlignment': json.loads(es_object.chart_settings_persistent_x_alignment),
                ...
                'hiddenMetrics': json.loads(es_object.chart_hidden_metrics),
            },
        },
        'search': {
        ...
        'contextFilter': {
            'groupByColor': json.loads(es_object.context_filter_group_by_color),
            'groupByStyle': json.loads(es_object.context_filter_group_by_style),
            'groupByChart': json.loads(es_object.context_filter_group_by_chart),
            'groupAgainst': {
        ...
        'sortFields': json.loads(es_object.sort_fields),
        'rowHeightMode': es_object.row_height_mode,
        'columnsOrder': {
            'left': json.loads(es_object.columns_order_left),
            'middle': json.loads(es_object.columns_order_middle),
            'right': json.loads(es_object.columns_order_right),
        },
        'columnsWidth': json.loads(es_object.columns_width),
        'excludedFields': json.loads(es_object.excluded_fields),
