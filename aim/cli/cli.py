...
from aim.cli.configs import INIT_NAME, VERSION_NAME, UP_NAME, UPGRADE_NAME, INDEX_NAME
...
from aim.cli.index import commands as index_commands
...
cli_entry_point.add_command(index_commands.index, INDEX_NAME)
