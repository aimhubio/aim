...
| `upload`    | Create snapshot of .aim directory and upload to cloud storage. Bucket name should be specified |
...
| Args                              | Description                                               |
| --------------------------------- | --------------------------------------------------------- |
| `--bucket <bucket_name>`          | Name of clpud storage bucket. __Required.__               |
