...
### Done
  ...
  - [x] LightGBM integration (Start: _14 Apr 2022_, Shipped: _May 17 2022_)
  - [x] CatBoost integration (Start: _20 Apr 2022_, Shipped: _May 17 2022_)
  - [x] Run execution details(display stdout/stderr logs) (Start: _25 Apr 2022_, Shipped: _May 17 2022_)
...
- ML Frameworks:
    - Shortlist: MONAI, SpaCy, AllenNLP, Raytune, Fairseq, fast.ai, KerasTuner
